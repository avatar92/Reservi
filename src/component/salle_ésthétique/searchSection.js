            ...
            <div className="search-inner-section">
                <form className="search">
                    <div className="a-field search__field">
                        <input type="text" id="query" className="r-text-field a-field__input search__input" placeholder="cherchez votre salle" required onChange={(e)=>this.setState({input:e.target.value})} />
                    ...
                    <button className="r-button search__button search__submit" type="submit">
                        ...
                        <svg  onClick={(e)=>{this.props.search(this.state.input)
                                e.preventDefault()}}
